// Roadmap modal — soft lead capture, opens from "Book the diagnostic" CTAs
const RoadmapModal = ({ open, onClose }) => {
  ...
  return (
    <div className="modal-backdrop modal-in" onClick={onClose}>
      <div className="modal-shell modal-shell-in" onClick={(e) => e.stopPropagation()}>
